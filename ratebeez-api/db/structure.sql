...
--
-- Name: index_api_access_tokens_on_discarded_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_api_access_tokens_on_discarded_at ON public.api_access_tokens USING btree (discarded_at);


--
-- Name: index_api_access_tokens_on_token; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_api_access_tokens_on_token ON public.api_access_tokens USING btree (token);

...
import logoPath from '@picasso/shared/assets/logo/web/svg/white.svg';
...
const userNavigation = [
  { name: 'Your Profile', href: '/auth/update' },
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-picasso-primary-900">

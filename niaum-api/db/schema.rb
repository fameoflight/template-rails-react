...
ActiveRecord::Schema[7.0].define(version: 2024_05_03_063410) do
  ...
  create_table "super_users", force: :cascade do |t|
    ...
    t.bigint "spoof_user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["spoof_user_id"], name: "index_super_users_on_spoof_user_id"
    t.index ["user_id"], name: "index_super_users_on_user_id", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.citext "provider", default: "email", null: false
    t.citext "uid", default: "", null: false
    t.string "otp_secret"
    t.index ["confirmation_token"], name: "index_users_on_confirmation_token", unique: true
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
    t.index ["uid", "provider", "email"], name: "index_users_on_uid_and_provider_and_email", unique: true
